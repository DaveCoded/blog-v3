...
Whoops! I've borked it again. One of my commits contained my changes to the yarn.lock.

<MarginNote id={1}>...that only work with *my* local environment because web development with billions of node modules is just wonderful</MarginNote>
...
And I'm saved thanks to [this SO answer](https://stackoverflow.com/questions/38743912/remove-a-file-from-a-git-pull-request).
Many thanks to [Jared Wilber](https://www.jwilber.me/) for saving my bacon.