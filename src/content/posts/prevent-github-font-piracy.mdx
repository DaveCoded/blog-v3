...
If you want to custom fonts, self-hosting is the best strategy for many websites.
Done correctly, it yields the decent performance results and gives you the most flexibility.
